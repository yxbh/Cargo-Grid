...
The two shallow variants retain a 60 mm floor depth, panel seat Y=47, panel plug tips Y=59.8 and the original two-row wall Z grid. Their natural filled rear profile rises 107 mm across the available 42.8 mm upper run rather than forcing the original 45-degree slope. The upper rear body stays behind the connector root while both floor and panel X regions remain exact. The exposed thick front-to-slope transition uses R3; other thick free body edges remain R2, the thin bearing lip remains R1 and the internal panel-bearing corner stays exact. Source bounds remain 60x60x140.378 mm and 120x60x140.378 mm including downward plugs.
