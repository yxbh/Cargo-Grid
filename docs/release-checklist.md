...
Exclude local locks, environments, caches, reference meshes, system profiles, G-code, study output and runtime diagnostics. The maintained documentation images are the exception: six overview images, 56 accessory thumbnails and their provenance manifest. The source archive contains exactly 62 PNGs; the runtime wheel contains none.
